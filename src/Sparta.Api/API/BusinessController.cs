...
public class BusinessController(IObjectSpaceFactory factory, ISecurityStrategyBase strategy) : ControllerBase {
    ...
    public IActionResult Order(int id) {
        ...
        return Ok(new { order.Id, order.OrderNumber, order.CustomerId, order.Status, order.CreatedByUserId, order.CreateByUserName,
    ...
    public IActionResult CreateOrder(CreateOrderRequest request) {
        ...
        order.Customer = customer; order.OrderNumber = request.OrderNumber;
        os.CommitChanges();
